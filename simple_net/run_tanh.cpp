...
//    net.initBias(s);
    ...
    get_input_label("./data/input_label_0-1_train_upper.xml", input, label, 260);
    ...
    timeStr<<now->tm_sec;
    std::string log_path = "./data/tanh_smote_" + timeStr.str() + ".csv";
...
//    net.train1(input, label, loss_threshold);
     ...
     */
    //Save the model
    net.save("./models/model_tanh_1_0.005_20_500000_{26_50_2}_smote.xml");
    return 0;
}
